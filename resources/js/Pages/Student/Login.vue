...
<template>
    <div class="min-h-screen flex flex-1 flex-col bg-[#E5E5E5]">
        <HeaderSection />

        <div class="bg-white">
            <div class="mx-auto ring-1 ring-gray-200 max-w-7xl mt-24 mb-6 flex flex-1 flex-col bg-white lg:flex-row">
                ...
                <div class="items-center m-10">
                    <div class="max-h-fit mx-auto w-full lg:w-96">
                        ...
                        <div>
                            ...
                            <h2 class="mb-6 mt-3 text-center text-2xl font-bold leading-9 tracking-tight text-gray-900">
                                Student
                                Login</h2>
                        </div>
                        ...
                        <div class="items-center w-full">
                            <form class="space-y-5" @submit.prevent="submit">
                                ...
                                <div>
                                    ...
                                    <div class="relative">
                                        ...
                                        <div
                                            ...
                                            <eye-off-icon v-else class="w-5 h-5 text-primary" @click="showPassword()" />
                                        </div>
                                    </div>
                                </div>
                                <div class="flex flex-col items-center lg:flex-row lg:justify-between">
                                    <div class="items-center relative hidden lg:inline-flex">
                                ...
                                <div class="flex gap-6">
                                    <button
                                        class="flex w-full justify-center rounded-xl bg-primary px-4 py-2 font-heading text-sm font-semibold leading-6 text-white shadow-sm hover:bg-primary-darker focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                                        type="submit">
                                        Sign In
                                    </button>
                                    <button
                                        class="flex w-full justify-center rounded-xl bg-secondary px-4 py-2 font-heading text-sm font-semibold leading-6 text-white shadow-sm hover:bg-secondary focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
                                        type="button" @click="visitRegister">
                                        Register
                                    </button>
                                </div>
                            </form>
