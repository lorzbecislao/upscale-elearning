...
<template>
    ...
    <div aria-live="assertive"
        class="fixed top-6 z-20 right-12 flex items-end px-4 py-6 pointer-events-none sm:p-6 sm:items-start">
        <div class="w-full flex flex-col items-end space-y-4">
            ...
            <transition enter-active-class="transform ease-out duration-300 transition"
                ...
                <div v-if="$page.props.flash.success && show"
                    ...
                    <div class="p-4" :class="$page.props.flash.success.type == 'deactivate' ? 'bg-amber-50' : ''">
                        <div class="flex justify-between">
                            <div class="flex items-start gap-3">
                                <WarningIcon v-if="$page.props.flash.success.type == 'deactivate'" aria-hidden="true"
                                    class="h-6 w-6 text-[#ffa351]" />
                                <CheckCircleIcon v-else aria-hidden="true" class="h-6 w-6 text-green-success" />
                                <div>
                                    <p class="font-medium font-heading text-black-darkest">
                                        {{ $page.props.flash.success.header }}
                                    </p>
